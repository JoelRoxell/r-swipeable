...
var Swipeable = function (_Component) {
  ...
  _createClass(Swipeable, [{
    ...
    key: 'setStyle',
    value: function setStyle(position) {
      var style = _style2.default.swipeableContent;
      var translateStr = 'translate3d(' + position.x + 'px, 0, 0)';
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          {
            defaultStyle: { x: 0 },
            style: { x: (0, _reactMotion.spring)(this.state.contentPos, {
          ...
          function (interpolatingStyle) {
            return _react2.default.createElement(
              'div',
              {
                style: _this2.setStyle(interpolatingStyle),
